...
module.exports = {
	content: [
		'./src/app/**/*.{ts,js}',
		'./src/assets/core/components/**/*.{ts,js}',
		'./views/**/*.html',
		'./dist/html/**/*.html'
	],
	safelist: [
	...
	plugins: [
		require('./src/assets/core/plugins/plugin'),
		require('./src/assets/core/plugins/components/theme'),
		require('./src/assets/core/plugins/components/breakpoints'),
		require('./src/assets/core/plugins/components/typography'),
		require('./src/assets/core/plugins/components/menu'),
		require('./src/assets/core/plugins/components/dropdown'),
		require('./src/assets/core/plugins/components/accordion'),
		require('./src/assets/core/plugins/components/input'),
		require('./src/assets/core/plugins/components/input-group'),
		require('./src/assets/core/plugins/components/select'),
		require('./src/assets/core/plugins/components/textarea'),
		require('./src/assets/core/plugins/components/file-input'),
		require('./src/assets/core/plugins/components/switch'),
		require('./src/assets/core/plugins/components/checkbox'),
		require('./src/assets/core/plugins/components/radio'),
		require('./src/assets/core/plugins/components/range'),
		require('./src/assets/core/plugins/components/container'),
		require('./src/assets/core/plugins/components/image-input'),
		require('./src/assets/core/plugins/components/modal'),
		require('./src/assets/core/plugins/components/drawer'),
		require('./src/assets/core/plugins/components/tooltip'),
		require('./src/assets/core/plugins/components/popover'),
		require('./src/assets/core/plugins/components/btn'),
		require('./src/assets/core/plugins/components/btn-group'),
		require('./src/assets/core/plugins/components/tabs'),
		require('./src/assets/core/plugins/components/pagination'),
		require('./src/assets/core/plugins/components/card'),
		require('./src/assets/core/plugins/components/table'),
		require('./src/assets/core/plugins/components/badge'),
		require('./src/assets/core/plugins/components/rating'),
		require('./src/assets/core/plugins/components/scrollable'),
		require('./src/assets/core/plugins/components/progress'),
		require('./src/assets/core/plugins/components/apexcharts'),
		require('./src/assets/core/plugins/components/leaflet')
	]
};
